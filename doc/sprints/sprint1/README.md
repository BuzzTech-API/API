...
1. ### Identificação dos computadores<a id='identificação'></a>
   ...
   | ![Laboratório com 32 computadores](C:\Users\gm_bi\Documents\GitHub\API_ADS_2022.2_SOS\doc\sprints\sprint1\img\32comp.png) | ![Laboratório com 24 computadores](C:\Users\gm_bi\Documents\GitHub\API_ADS_2022.2_SOS\doc\sprints\sprint1\img\24comp.png) |
   | ------------------------------------------------------------ | ------------------------------------------------------------ |
...
5. ### Criação, aprovação e entrega do Wireframe<a id='wireframe'></a>
   ...
   | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
   | ![Home](C:\Users\gm_bi\Documents\GitHub\API_ADS_2022.2_SOS\doc\sprints\sprint1\img\Página Home.png) | ![Abertura de Chamado](C:\Users\gm_bi\Documents\GitHub\API_ADS_2022.2_SOS\doc\sprints\sprint1\img\Abertura de chamados.png) | ![Visualização de Chamado](C:\Users\gm_bi\Documents\GitHub\API_ADS_2022.2_SOS\doc\sprints\sprint1\img\Visualização de chamados.png) |

   Para visualizar o *Wireframe* em PDF, acesse o <a href=''>link :link:</a>.
...
## :mega: Apresentação da Sprint<a id='#apresentação'></a>
 ...
 <iframe width="100%" height="800" src="C:\Users\gm_bi\Documents\GitHub\API_ADS_2022.2_SOS\doc\sprints\sprint1\img\Sprint1 - API - BuzzTech.pdf">
